...
namespace IslandFoodmart.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserEmailStore<DatabaseUser> _emailStore;
        ...
        private DatabaseUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<DatabaseUser>();
            }
            catch
            {
        ...
        private IUserEmailStore<DatabaseUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<DatabaseUser>)_userStore;
        }
    }
}
