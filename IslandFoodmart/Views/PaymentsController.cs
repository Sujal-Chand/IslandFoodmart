...
namespace IslandFoodmart.Views
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentID,PaymentAmount,PaymentMethod,PaymentDate")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentID,PaymentAmount,PaymentMethod,PaymentDate")] Payment payment)
        {
